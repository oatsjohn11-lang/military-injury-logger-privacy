...
For the purposes of this Privacy Policy:
  ...
  * Application refers to Military Injury Logger, the software program
    provided by the Company.

  * Company (referred to as either "the Company", "We", "Us" or "Our" in this
    Privacy Policy) refers to Military Injury Logger.
...
of Personal Data based on the purpose of processing and legal obligations:
  ...
  * Usage Data
    ...
    * Server logs (IP addresses, access times): up to 24 months for security
